        ...
        {categories.map(
          (category) => (
            <button
              ...
              className="bg-gray-100 dark:bg-[#0B1220] border border-gray-200 dark:border-white/10 hover:bg-blue-600 dark:hover:bg-blue-600 hover:text-white shadow-lg dark:shadow-[0_0_25px_rgba(59,130,246,0.15)] hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 rounded-3xl py-10 px-4 text-center font-bold text-black dark:text-white cursor-pointer"
            >
              {category}
            </button>
          )
